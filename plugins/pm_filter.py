...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝖥𝗂𝗅𝖾 𝖲𝗍𝗈𝗋𝖾 📁', callback_data='contecttr')            
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('🛠 𝖴𝗉𝖽𝖺𝗍𝖾𝗌', url='https://t.me/MDR_MOVIES'),
            InlineKeyboardButton('⚙ 𝖲𝗎𝗉𝗉𝗈𝗋𝗍', url='https://t.me/MDR_CHAT_BOX')
            ],[
...
async def advantage_spell_chok(msg):
    ...
    f = await msg.reply("<i>I couldn't find anything related to that Did you mean any one of these?</i>\n\n<i>Or try again by checking your movie/series name on Google.</i>", reply_markup=InlineKeyboardMarkup(btn))
